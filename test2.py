...
class HotelReservationApp:
    ...
    def show_record(self):
        ...
        if self.records:
            ...
            self.check_in_var.set(current_record[2].strftime('%d-%m-%Y'))  # Format date when displaying
            self.check_out_var.set(current_record[3].strftime('%d-%m-%Y'))  # Format date when displaying
    ...
    def add_new(self):
        ...
        new_record = (
            ...
            datetime.strptime(self.check_in_var.get(), '%d-%m-%Y').date(),  # Parse and format date
            datetime.strptime(self.check_out_var.get(), '%d-%m-%Y').date(),  # Parse and format date
